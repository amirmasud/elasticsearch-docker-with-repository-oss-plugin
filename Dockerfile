...
RUN curl -L https://github.com/zhichen/elasticsearch-repository-oss/releases/download/v5.5.3/elasticsearch-repository-oss-5.5.3.zip -o /tmp/elasticsearch-repository-oss.zip && \
    ...
    sed -i "/elasticsearch.version=5.5.3/c elasticsearch.version=6.3.1" /usr/share/elasticsearch/plugins/repository-oss/plugin-descriptor.properties && \
    sed -i "/version=5.5.3/c version=6.3.1" /usr/share/elasticsearch/plugins/repository-oss/plugin-descriptor.properties && \
